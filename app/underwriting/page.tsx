...
export const metadata: Metadata = {
  title: "Underwriting | Michael Aylett",
  description:
    "Estimate co-living rental income, operating expenses, total capital required, monthly cash flow, and cash-on-cash return with this interactive property underwriting calculator.",
};
        ...
        <div className="relative mx-auto max-w-content px-6 md:px-10">
          <div className="max-w-2xl">
            ...
            <p className="mt-8 text-slate text-base md:text-lg leading-relaxed">
              ...
              projected cash-on-cash return for a co-living property.
            </p>
          </div>
        </div>
      </section>
